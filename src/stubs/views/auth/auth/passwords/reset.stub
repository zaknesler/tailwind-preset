        ...
        <div class="p-0 m-auto max-w-md w-full">
            <div class="m-6 sm:m-10">
                ...
                <div class="mt-8 bg-white rounded-lg">
                    ...
                    <form class="w-full rounded-b-lg shadow-xl" action="{{ route('password.request') }}" method="POST">
                        @csrf

                        <input type="hidden" name="token" value="{{ $token }}" />

                        <div class="p-8 text-gray-700 text-center">Enter a new password</div>
                        ...
                        <div class="mt-6 px-8 py-6 bg-gray-100 rounded-b-lg flex justify-center">
                            <input tabindex="4" class="btn px-8" type="submit" value="Reset Password" />
                        </div>
                    </form>
                </div>
            </div>
